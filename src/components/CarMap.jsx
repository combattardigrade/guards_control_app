...
const carIcon = require('./carIcon.png')
const mapStyles = {
    width: '100%',
...
class MyMap extends Component {
    ...
    render() {
        ...
        const { location, points, google } = this.props
        ...
        return (
            ...
            >
                {/* {this.displayMarkers()} */}
                <Marker id='currentLocation' icon={{ url: carIcon, scaledSize: { width: 42, height: 48 } }} position={{ lat: location.lat, lng: location.lng }} />
