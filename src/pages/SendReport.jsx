                ...
                <IonContent>
                    <IonItem>
                        <IonGrid>
                            ...
                            <IonRow>
                                <IonCol> <IonInput value="Ventana rota"></IonInput></IonCol>
                            </IonRow>
                        </IonGrid>
                    </IonItem>
                    <IonItem>
                    ...
                    <div style={{ bottom: '10px', position: 'absolute', padding: '10px', width: '100%' }}>
                        <ion-button color="light" expand="full" type="submit" className="ion-no-margin">Ver Historial de Reportes</ion-button>
                    </div>
